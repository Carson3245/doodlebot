...
echo.
echo Preparing Hugging Face model cache...
call npm run prepare:model
if errorlevel 1 (
  echo.
  echo Failed to download or initialize the configured model. Review the messages above for details.
  exit /b 1
)
